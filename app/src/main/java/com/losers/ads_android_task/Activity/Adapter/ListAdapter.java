    ...
    switch (v.getId()) {
      ...
      case R.id.cardview:
        ...
        if (mListAdapterListener != null) {
          mListAdapterListener.onClick(mComicResponse.getImg(), mComicResponse.getTitle(), getFormattedDate(mComicResponse.getDay(),mComicResponse.getMonth(),mComicResponse.getYear()),
...
//    result.startAnimation(animation);
    ...
    viewHolder.mDateTv.setText(getFormattedDate(ComicResponse.getDay(),ComicResponse.getMonth(),ComicResponse.getYear()));
